...
8. On the General tab, set your unique Bundle Identifier(correspond with Apple ID's Bundle Identifier created in Apple Developer Program) and Signing values. 
