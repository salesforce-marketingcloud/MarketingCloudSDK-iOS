...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func configureSFMCSdk() -> Bool {
        ...
        let mobilePushConfiguration = PushConfigBuilder(appId: appID)
            ...
            .setEnableScreenEntryTracking(false) // Key to enable or disable screen entry tracking, default is true
            .build()
        
        // Override the Keychain Accessibility attribute set by the SDK, defaults to kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly
        SFMCSdk.setKeychainAccessibleAttribute(accessibleAtrribute: kSecAttrAccessibleWhenUnlockedThisDeviceOnly)
