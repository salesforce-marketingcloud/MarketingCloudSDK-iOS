...
order: 1
---
Use the SDK to easily incorporate inbox functionality into your mobile app. All active inbox messages download to the mobile device every time the app is brought to the foreground.
...
This example includes a simple implementation of an inbox using the SDK as datasource and delegate.
...
### Related Items
* [InboxMessages Methods]({{ site.baseurl }}/appledoc/Classes/MarketingCloudSDK.html#task_InboxMessages%20Methods)
