...
@interface SFMarketingCloudSdk : NSObject <SFMCModule>
...
/// Initialize MarketingCloudSdk and return Shared instance
/// <ul>
///   <li>
///     Returns    SFMCModule MarketingCloudSdk
///     :nodoc:
///   </li>
/// </ul>
...
/// Requests the MarketingCloudSdk Module when it’s operational and safe to use. The provided callback will be invoked with the MarketingCloudSdk Module when it’s ready.
/// All MarketingCloudSdk module-related API calls should be made within this function.
/// \param callback A callback that will receive the MarketingCloudSdk Module when it’s operational/ready.
///
+ (void)requestSdk:(void (^ _Nonnull)(id <MarketingCloudSdkInterface> _Nullable))callback;
/// :nodoc:
+ (enum SFMCSdkModuleStatus)_getStatus SWIFT_WARN_UNUSED_RESULT;
...
@interface SFMarketingCloudSdk (SWIFT_EXTENSION(MarketingCloudSDK))
/// :nodoc:
+ (void)tearDownModule;
@end

@class SFMCSdkMessage;
@interface SFMarketingCloudSdk (SWIFT_EXTENSION(MarketingCloudSDK)) <Subscriber>
...
@interface SFMarketingCloudSdk (SWIFT_EXTENSION(MarketingCloudSDK)) <MarketingCloudSdkProtocol>
...
@interface SFMarketingCloudSdk (SWIFT_EXTENSION(MarketingCloudSDK)) <MarketingCloudSdkInterface>
...
///
- (void)setDebugLoggingEnabled:(BOOL)enabled;
/// MarketingCloudSdk.shared.getLogger().d(category: .event, message: “Message”)
...
///
/// \param shipping Order Dictionary returned by shipping
///
/// \param discount Order Dictionary returned by discount
///
/// \param cart Order Dictionary returned by cart
///
- (NSDictionary * _Nullable)orderDictionaryWithOrderNumber:(NSString * _Nonnull)orderNumber shipping:(NSNumber * _Nonnull)shipping discount:(NSNumber * _Nonnull)discount cart:(NSDictionary * _Nonnull)cart SWIFT_WARN_UNUSED_RESULT;
...
/// This class  is used to set the configuration neded for MarketingCloudSdkConfig module
/// :nodoc:
...
///   </li>
///   <li>
///     Returns returns the MarketingCloudSdkConfigBuilder instancetype value
///   </li>
/// </ul>
...
///   </li>
/// </ul>
/// \param markMessageReadOnInboxNotificationOpen enables or disables this marking of inbox messages as read upon clicking the inbox notification. 
///
...
/// <ul>
///   <li>
///     Returns MarketingCloudSdkConfigBuilder containing the current builder configuration settings.
///   </li>
/// </ul>
