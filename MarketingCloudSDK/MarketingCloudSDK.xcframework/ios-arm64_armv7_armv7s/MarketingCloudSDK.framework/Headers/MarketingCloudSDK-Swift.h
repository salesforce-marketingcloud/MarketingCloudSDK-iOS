...
/// This method is used to update the identities like profile atributes and contactKey
/// \param message SFMCEvent, publish to specific Custom event
///
/// \param category Message Object which contains producer, consumer, priority, timestamp, category and fromEvent
///
