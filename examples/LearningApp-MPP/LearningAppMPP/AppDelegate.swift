...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // -> the SDK would have not initialized yet, the notification object should be persisted and set back to the MarketingCloudSDK when ready.
    ...
    func setupMobilePush() {
        ...
        SFMCSdk.mp.setRegistrationCallback { reg in
            ...
            SFMCSdk.mp.unsetRegistrationCallback()
    ...
    func messaging(_ messaging: Messaging, didReceiveRegistrationToken fcmToken: String?) {
        ...
        if (SFMCSdk.mp.getStatus() == .operational) {
            ...
            if let apnsToken = messaging.apnsToken {
                ...
                SFMCSdk.mp.setDeviceToken(apnsToken)
            } else {
                print("fcm token is null")
            }
            print("SDK is not yet operational")
        }
    }
}
